...
*   **FHE in 2026: Possibilities, Limits, and Recent Directions.**
	*	June 2026 - At the Workshop on Fully Homomorphic Encryption held at the Institute of Information Engineering - Chinese Academy of Sciences (Beijing, China 🇨🇳) - with Damien Ligier.
...
*   **Fully Homomorphic Encryption - ML Applications and New Directions.**
	*	July 2024 - At PET Meetup (Seoul, South Korea 🇰🇷) - with Damien Ligier.
...
*   **Introduction to FHE, TFHE and Machine Learning applications.**
	...
	*	June 2021 - At CRC Seminar Series (TII Abu Dhabi, United Arab Emirates 🇦🇪, webinar).
	*	May 2021 - At IMDEA seminar (IMDEA Madrid, Spain 🇪🇸, webinar).
...
*   **Programmable Bootstrapping Enables Efficient Homomorphic Inference of Deep Neural Networks.**
	*	July 2021 - At CSCML 2021 (webinar).
...
*   **Introduction to FHE and applications to Machine Learning.**
	*	December 2020 - At Seminario di Logica e Informatica Teorica (Università Roma Tre, Roma, Italy 🇮🇹, webinar).
...
*   **Introduction to FHE and the TFHE Scheme.**
	*	April 2020 - At the "Lattices: From Theory to Practice" workshop (Simons Institute, University of California, Berkeley, USA 🇺🇸, webinar). [<span style="color:#c05252">Video</span>](https://www.youtube.com/watch?v=28XlccZgiUM){:target="_blank"}
...
*   **Faster Packed Homomorphic Operations and Efficient Circuit Bootstrapping for TFHE.**
	...
	*	December 2017 - At Asiacrypt 2017 (Hong Kong 🇭🇰) - with Mariya Georgieva.
...
*   **An Homomorphic LWE based E-voting Scheme.** 
	...
	*	February 2016 - At PQCrypto 2016 (Fukuoka, Japan 🇯🇵). [<span style="color:#c05252">Slides</span>](https://pqcrypto2016.jp/data/Chillotti-Gama_Georgieva_Izabachene-An_Homomorphic_LWE-based_E-voting_Scheme-less-pauses.pdf){:target="_blank"}
...
*   **Fully Homomorphic Encryption (6h class)**
	*	August 2026 - At IACR-VIASM Summer School on Cryptography 2026 (Hanoi, Vietnam 🇻🇳). [<span style="color:#c05252">Slides</span>](https://drive.google.com/file/d/1TE8U_zSPSTMLeoTJ1nj9exgzXqaLNy-n/view?usp=share_link){:target="_blank"}
